...
if ( $compset->meets_min_num_product_requirement() || dfrcs_can_manage_compset() ) :
	...
	if ( 1 == DfrTmpl::getOption( 'show_title' ) ) echo '<h2>' . dfrcs_title() . '</h2>'; ?>
				...
				?>
					<li class="<?php echo dfrcs_row_class(); ?>">
						<a target="_blank" href="<?php echo dfrcs_url(); ?>" rel="nofollow">
							<div class="item">
								<?php 
									if ( 1 == DfrTmpl::getOption( 'show_image' ) ) echo '<div class="dfrcs_image">' . dfrcs_image() . '</div>';
									if ( 1 == DfrTmpl::getOption( 'show_merchant' ) ) echo '<div class="dfrcs_logo">' . dfrcs_logo() . '</div>';
									if ( 1 == DfrTmpl::getOption( 'show_price' ) ) echo '<div class="dfrcs_price">' . dfrcs_price() . '</div>'; 
								?>
